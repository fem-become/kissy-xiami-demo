KISSY.add("xiami/header", function(S, Node, Transition, Event, DD) {
  var $ = S.all;
  var header = $("#header");
  var currentHeader = null;
  var headerMap = {};
  var isRunOnce = false;
  var TPL = '<div class="header-page">' + '<a href="javascript:;" class="go-back"></a>' + '<a href="javascript:;" class="go-cat"></a>' + '<div class="do-search"></div>' + '<div class="title">\u5348\u540e\u97f3\u4e50</div>' + "</div>";
  return{getHeader:function(mod) {
    if(currentHeader) {
      currentHeader.hide()
    }
    if(headerMap[mod]) {
    ...
    if(mod === "xiami/transition/home" && isRunOnce == false) {
      ...
      var d = new DD.Draggable({node:cattEl, handlers:[cattEl]});
      var initX = null;
      var pEl = $("#page");
